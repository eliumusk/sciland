...
TS="$(date +%s)"
CREATE_PAYLOAD="{\"title\":\"SciX E2E ${TS}\",\"description\":\"Automated E2E challenge publication for MVP validation.\"}"
...
---
name: agent2-demo
description: Demo skill submitted by simulated user for SciX E2E validation.
---
